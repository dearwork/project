...
! function (a, b, c, d) {
    ...
    var f = "slotMachine",
        ...
        h = "slotMachineNoTransition",
        i = "slotMachineBlurFast",
        j = "slotMachineBlurMedium",
        k = "slotMachineBlurSlow",
        l = "slotMachineBlurTurtle",
        m = "slotMachineGradient",
        n = m,
        o = function () {
            function a(b, c) {
        ...
        p = function () {
            ...
            return _createClass(c, [{
                ...
                value: function () {
                    var a = this._delay || this.settings.delay,
                        b = this._transition || this.settings.transition;
                ...
                value: function (a) {
                    ...
                    switch (this._transition = "linear", a) {
                        case 1:
                            b /= .5, this._transition = "ease-out", this._animationFX = l;
                            break;
                        case 2:
                ...
                key: "visibleTile",
                get: function () {
                    var a = this.$tiles.first().height(),
                        b = this.$container.css("transform"),
                        c = /^matrix\(-?\d+,\s?-?\d+,\s?-?\d+,\s?-?\d+,\s?-?\d+,\s?(-?\d+)\)$/,
                        d = parseInt(b.replace(c, "$1"), 10);
                ...
                get: function () {
                    var c = a(b),
                        d = this.$slot.offset().top > c.scrollTop() + c.height(),
