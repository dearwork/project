...
<%
	...
	if(rs.next()){
		...
		String Dredate = rs.getString("regDate");
...
<body>
		...
		<div id="wrap">
            <div class="box">
                <h3><%= session.getAttribute("user_NAME")%>님의 정보</h3>
                <form name="form" action="process/updateproc.jsp" method="post" autocomplete="off">
                    <div class="inputBox">
                        <input type="text" name="name" id="name" required value="<%= Dname%>">
                        <label>이름(닉네임)</label>
                        <p id="namep">* 이름(닉네임)은 언제든 변경이 가능합니다.</p>
                        <input type="hidden" id="inDuplication" value="udUncheck"></input>
                    </div>
                    <div class="inputBox radioBox">
		                <label style="margin-right: 10px; color: #fff;">이전에 선택한 연령: <%= Dage%></label>
                    ...
                    <div class="inputBox idBox">
                        <input type="text" name="id" id="id" required  value="<%= Did%>" required>
                    ...
                    <div class="inputBox emailBox">
                        <input type="text" name="email" id="email" required  value="<%= Demail%>">
                        <label>이메일</label>
                        <p class="text">*이메일을 입력해주세요.</p>
                    </div>
                    <div class="inputBox">
                        <input type="password" name="pass" id="passField" class="pass" required  value="<%= Dpwd%>">
                        <label>비밀번호(8~)</label>
                        <div class="show-btn">
                    ...
                    <ul class="faq-text">
                        <li>
                            <div class="logincheck">
                                ...
                                <input type="checkbox" name="Check" id="Check"  onclick="checkSelectAll(this)" checked>
                        ...
                        <li>
                            <div class="logincheck">
                                ...
                                <input type="checkbox" name="Check" id="Check2" onclick="checkSelectAll(this)" checked>
                        ...
                        <div class="allcheckbox" checked readonly>
                            <label for="allCheck" class="checkbox">
                                <input type="checkbox" name="selectall" id="allCheck" onclick="selectAll(this)" value="y" checked >
                                <div id="icon"></div>
                                <p>모든 약관에 동의합니다.</p>
                            </label>
                        </div>
                    </ul>
                    <input type="button" value="수정하기" onclick="checkjoin()"><br>
    ...
    <script>
        ...
        idInput.addEventListener("keyup", (e)=>{
            ...
            if(idInput.value == ""){
                ...
                Idtext.style.color = "red";
                return false;
            }else if( againCheck.value == 2 || againCheck.value == 0){
            	idInput.value == "";
            	Idtext.innerText = "다른 아이디를 입력해주세요.";
                Idtext.style.color = "red";
                return false;
            }else{
