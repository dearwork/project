...
<body>
	<div id="bigf">
        ...
        <div id="wrap">
            <div class="box">
                <h3>Find ID</h3>
                <form name="form"  action="process/findprocess.jsp"  method="post" autocomplete="off"s>
                    <div class="inputBox">
                    ...
                    <input type="button" name="" value="아이디 찾기" onclick="document.form.submit();"><br>
                    <a href="Findpass.jsp">비밀번호 찾기 <span>Click!</span></a>
                    <div class="aBox">
                        <a href="Login.jsp">로그인페이지로 돌아가기</a>
                        &nbsp; / &nbsp; 
                        <a href="join.html">회원이 아니신가요?</a>
                    </div>
                </form>
            </div>
