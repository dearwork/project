...
<head>
    ...
    <link rel="stylesheet" href="CSS/mypage_admin.css">
	...
	if(rs.next()){
        ...
        <div id="wrap">
            ...
            <div class="userName">
                ...
                <hr>
                <div class="iconbox">
                    <a href=""><i class='bx bx-cog'><span>수정하기</span></i></a>
                    <a href=""><i class='bx bx-user-circle' ><span>이용회원</span></i></a>
