    ...
    <div id="bigf">
        ...
        <div id="wrap">
            ...
            <div class="checkbox">
                ...
                <div class="selectbox">
                    ...
                    <label for="allCheck" class="checkbox adultBox">
                        <input type="checkbox" name="notice" id="allCheck" value="공지사항">
                        <div id="icon"></div>
                        <p>공지사항</p>
                    </label>
        ...
        function checkText() {
            ...
            $('iframe').load(function() {
                ...
                var iSource = document.getElementById('output').src;
                document.getElementById('output').src = '';
                document.getElementById('output').src = iSource;
            });
            function iResize() {
                document.getElementById('output').style.height = 
                document.getElementById('output').contentWindow.document.body.offsetHeight + 'px';
            }
        </script>
        </div><!--wrap Fin-->
    </div><!--bigf Fin-->
